            ...
            <div class="col-md-9 col-lg-8 mx-auto">
              ...
              <form class="form" action="<?php echo site_url('/account/login') ?>" method="POST" msg="Logging In">
                <div class="form-group">
                  ...
                  <input type="hidden" name="acct_type" class="form-control" value="seller" readonly>
                </div>
                ...
                <div class="text-center">
                  ...
                  <a class="small" href="<?php echo site_url('seller/register') ?>">Dont have an account? Register</a>
                </div>
              </form>
            </div>
          </div>
