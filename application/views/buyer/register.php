            ...
            <div class="col-md-9 col-lg-8 mx-auto">
              ...
              <form class="form" action="<?php echo site_url('/account/register') ?>" method="POST" msg="Registration In Progress ...">
                <div class="form-group">
                  ...
                  <input type="hidden" name="acct_type" class="form-control" value="buyer" required>
                </div>
                <div class="form-group">
                ...
                <div class="text-center">
                  <a class="small" href="<?php echo site_url('/buyer/login') ?>">Already have an account? Login</a>
                </div>
              </form>
            </div>
          </div>
