                ...
                <div class="card-body" style="background: white; padding: 10px">
                    <div class="row">
                        <?php foreach($products as $product){ ?>
                            <a href="<?php echo site_url('/product/'.rand(0, 5)); ?>">
                                <div class="col-md-2 card product list-item-group-active">
                                    <img class="card-img" src="<?php echo site_url('public/images/shoe'.rand(0, 5).'.jpg') ?>" alt="Card image" style="height: 150px; width: 100%;">
