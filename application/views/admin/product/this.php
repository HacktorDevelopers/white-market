  ...
  <div class="container-fluid">
    ...
    <div class="card mb-3">
      <div class="card-header">
        ...
        <a href="<?php echo site_url('/admin/product/create') ?>" style="float: right" class="btn btn-sm btn-primary">New <span class="fa fa-plus"></span></a> &nbsp;
        <?php if($this->session->userdata('user')->user_id == $product['owner_id']){ ?>
          <a href="<?php echo site_url('/admin/product/edit/'.$product['code']) ?>" style="float: right" class="btn btn-sm btn-primary">Edit <span class="fa fa-edit"></span></a>
        <?php } ?>
      </div>
      <div class="card-body">
        <div class="row">
